            ...
            <div class="f-grid">
                <div>
                    ...
                    <div style="position:relative;">
                        <input type="password" id="password_input" name="password" placeholder="••••••••" class="f-input" style="padding-right: 40px;">
                ...
                <div>
                    ...
                    <div style="position:relative;">
                        <input type="password" id="password_confirm_input" name="password_confirmation" placeholder="••••••••" class="f-input" style="padding-right: 40px;">
