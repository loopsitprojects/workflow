...
.f-hint{font-size:11px;color:var(--color-text-secondary);margin-bottom:8px;font-weight:500;}
</style>
...
<div class="f-wrap">
    <form action="{{ route('users.update', $user) }}" method="POST">
        ...
        <div class="f-section">
            ...
            <input type="text" name="name" required placeholder="Full name…" class="f-title"
